...
const API = {
  ...
  saveTimeSettings(data) { return API.request('/api/time-settings', { method: 'POST', body: JSON.stringify(data) }); },
    saveStaSettings(data)  { return API.request('/api/sta-settings',   { method: 'POST', body: JSON.stringify(data) }); },
